...
<?php
$sql = mysqli_query($conn, "SELECT * FROM kategori_berita
ORDER BY kategori_berita ASC");
?>
<div class="wrapper">
              ...
              <tbody>
                ...
                foreach ($sql as $key => $value) { ?>
                  <tr>
                    ...
                    <td>
                    <a href="ubah.php?id=<?php echo $value['id_kategori_berita']; ?>" class="text-light btn btn-warning">Ubah</a> |    
                    <a href="hapus.php?id=<?php echo $value['id_kategori_berita']; ?>" class="btn btn-danger">Hapus</a>    
                  </td>
                  </tr>
                <?php } ?>
              </tbody>
