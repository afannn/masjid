  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Jenis Keuangan</h1>
          </div>
              ...
              <tbody>
                ...
                foreach ($sql as $key => $value) { ?>
                  <tr>
                    ...
                    <td>
                    <a href="ubah.php?id=<?php echo $value['id_jenis_keuangan']; ?>" class="text-light btn btn-warning">Ubah</a> |    
                    <a href="hapus.php?id=<?php echo $value['id_jenis_keuangan']; ?>" class="btn btn-danger">Hapus</a>    
                  </td>
                  </tr>
                <?php } ?>
              </tbody>
