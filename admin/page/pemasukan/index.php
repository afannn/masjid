              ...
              <tbody>
                ...
                foreach ($sql as $key => $value) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="ubah.php?id=<?php echo $value['id_pemasukan']; ?>" class="btn btn-sm btn-warning">Ubah</a> |
                      <a href="hapus.php?id=<?php echo $value['id_pemasukan']; ?>" class="btn btn-sm btn-danger">Hapus</a> |
