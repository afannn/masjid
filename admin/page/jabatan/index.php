              ...
              <tbody>
                ...
                foreach ($sql as $key => $value) { ?>
                  <tr>
                    ...
                    <td>
                    <a href="ubah.php?id=<?php echo $value['id_jabatan_detail']; ?>" class="text-light btn btn-warning">Ubah</a> |    
                    <a href="hapus.php?id=<?php echo $value['id_jabatan_detail']; ?>" class="btn btn-danger">Hapus</a>    
                  </td>
                  </tr>
                <?php } ?>
              </tbody>
